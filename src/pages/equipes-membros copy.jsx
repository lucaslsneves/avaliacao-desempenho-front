...
import { MdArrowBack, MdArrowForward, MdGridView, MdList } from "react-icons/md";
        ...
        >
          ...
          <VStack>
            <HStack mt="5" spacing="5" display="inline-flex">
             ...
             <IconButton   variant="outline" cursor={"pointer"}  colorScheme="green" icon={<MdGridView/>}/>
             <IconButton   variant="outline" cursor={"pointer"}  colorScheme="green" icon={<MdList/>}/>
